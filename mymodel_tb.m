...
%Hacer analisis para bacterias normalizadas y no normalizadas

%OutputVariable=T_tot(end) %agrupar este numero continuo en un discreto 0 y K
%OutputVariable=M_tot(end)
OutputVariable=T_tot(end)/k15 %o x(14)
%OutputVariable=tcrit1
